...
// inject into navigator.apps.services if it doesn't exist
if (!navigator.apps) navigator.apps = {};
if (!navigator.apps.services) navigator.apps.services = {};
...
if (!navigator.apps.services.contacts) {
    navigator.apps.services.contacts = (function() {
        ...
        var ContactServerOrigin = "http://localhost:8300";
        var ContactServerIncludePath = "/static/include.html";
        ...
        /* const */ var overlayId = "contactsConfirmOverlay";
        /* const */ var dialogId = "contactsTrustedIFrame";
        ...
        function setupWindow() {
            ...
            // Append iframe to the dom and load up the contacts server inside
            doc.body.appendChild(iframe);
            iframe.src = ContactServerOrigin + ContactServerIncludePath;
            ...
            // occasionally the server will request that we show/hide
            // its iframe content.
        ...
        // Return contacts object with exposed API calls
        return {
            get: callGet
        };
    })();
